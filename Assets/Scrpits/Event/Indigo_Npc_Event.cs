...
public class Indigo_Npc_Event : MonoBehaviour
{
    ...
    IEnumerator EventCoroutine()
    {
        ...
        else if (thePlayer.IndigoMap_Check != 0 && thePlayer.IndigoMap_Check != 4)
        {
            theDM.ShowDialogue(dialogue_2);
            yield return new WaitUntil(() => !theDM.talking);
        }
        else if (thePlayer.IndigoMap_Check == 4 && thePlayer.item_Check == 6)
        {
