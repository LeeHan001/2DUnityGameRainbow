...
public class Inventory : MonoBehaviour
{
    ...
    public void GetAnItem(int _itemID, int _count = 1)
    {
        ...
        Debug.Log("데이터 베이스에 해당 id의 아이템 존재 안함");
    }
    ...
    public void SelectedItem()
    {
        ...
        {
            Description_Text.text = "아직은 가지고 있는       물건이 없다.                     x키 : 나가기";
        }
   ...
   public void Clear()
    ...
    void Update()
    {
        if (!stopKeyInput)
        {
            if (Input.GetKeyDown(KeyCode.I) && theMenu.activated == false && SceneManager.GetActiveScene().name == "Start" && theDM.talking == false && thePlayer.Event == false)
            {
                activated = !activated;
