...
public class Yellow_Npc_Event : MonoBehaviour
{
    ...
    IEnumerator EventCoroutine()
    {
        ...
        if (thePlayer.Quest_Check == 4 && thePlayer.item_Check == 3)
        {
        ...
        else if (thePlayer.Quest_Check == 4 && thePlayer.item_Check == 4)
        {
