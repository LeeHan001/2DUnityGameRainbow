...
public class FadeManager : MonoBehaviour
{
    ...
    public void FalshOut(float _speed = 0.02f)
    {
        StopAllCoroutines();
        StartCoroutine(FalshOutCoroutine(_speed));
    }

    IEnumerator FalshOutCoroutine(float _speed)
    {
        color = white.color;
    ...
    public void FalshIn(float _speed = 0.02f)
    {
        StopAllCoroutines();
        StartCoroutine(FalshInCoroutine(_speed));
    }

    IEnumerator FalshInCoroutine(float _speed)
    {
        color = white.color;
