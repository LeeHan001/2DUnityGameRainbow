...
public class NumberSystem : MonoBehaviour
{
    ...
    public void ShowNumber(int _correctNumber)
    {
        ...
        //superObject.transform.position = new Vector3(superObject.transform.position.x + 50 * count, superObject.transform.position.y, superObject.transform.position.z);
        selectedTextBox = 0;
        result = 0;
        SetColor();
